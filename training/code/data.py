...
mean_emojixpress = sum_emojixpress / len(data)
print('{:.2f} млн'.format(mean_emojixpress))'''
...
for row in data:
    sum_emojixpress = 0
    sum_emojixpress += sum(row[1: len(row): ])

mean_emojixpress = sum_emojixpress/(len(row)-1)

#print(mean_emojixpress)
#print('{1}-{0: .2f}млн'.format(mean_emojixpress))
print('{1}-{0: .2f}млн'.format(mean_emojixpress, 1))'''
'''
